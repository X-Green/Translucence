...
public class ChunkSectionPos extends Vec3i {
    ...
    public static long fromGlobalPos(long globalLong) {
        return asLong(getSectionCoord(BlockPos.unpackLongX(globalLong)), getSectionCoord(BlockPos.unpackLongY(globalLong)), getSectionCoord(BlockPos.unpackLongZ(globalLong)));
    }
